                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding: 0 2.5em; text-align: left;">
                                <div class="text">
                                    <h2>This is your exam '{{ $result->Enrollment->Exam->exam_name }}' result.</h2>
                                    <h3>{{ $result->note }}</h3>
                                </div>
                            </td>
                        </tr>
            ...
            <tr>
                <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                        <th width="20%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Exam</th>
                        <th width="30%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Score</th>
                        <th width="30%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Time taken</th>
                        <th width="20%" style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px">Grade</th>
                    </tr>
                    <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                        <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                            <div class="text">
                                <p>{{ $result->Enrollment->Exam->exam_name }}</p>
                            </div>
                        </td>
                        <td valign="middle" width="30%" style="text-align:left; padding: 0 2.5em;">
                            <div class="text">
                                <p>{{ number_format($result->score, 2) }} / {{  number_format($result->Enrollment->Exam->ExamQuestion->total_marks, 2) }}</p>
                            </div>
                        </td>
                        <td valign="middle" width="30%" style="text-align:left; padding: 0 2.5em;">
                            <div class="text">
