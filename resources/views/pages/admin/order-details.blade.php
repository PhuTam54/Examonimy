...
@section("main")
    ...
    <div class="content-wrapper">
        ...
        @include("components.admin.invoice.content_header")
        <!-- /.content-header -->
...
{{--                                                    <img src=" {{ $item->thumbnail }}" width="100" alt="">--}}
                            ...
                            <div class="row">
                                ...
                                <!-- /.col -->
                                <div class="col-6">
                                    <p class="lead">Amount Due {{ $order->updated_at }}</p>
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    ...
                                    @switch($order->status)
                                        @case(0)
                                            <button type="button" class="btn btn-primary float-right"><i class="fa fa-check" aria-hidden="true"></i>
                                                Confirm
                                            </button>
                                        ...
                                        @case(1)
                                            <button type="button" class="btn btn-warning float-right"><i class="fa fa-truck" aria-hidden="true"></i>
                                                Ship
                                            </button>
                                            <button type="button" class="btn btn-danger float-right" style="margin-right: 5px;">
                                                <i class="fa fa-times" aria-hidden="true"></i> Cancel
                                            ...
                                            @break
                                        @case(2)
                                            <button type="button" class="btn btn-info float-right"><i class="fa fa-truck" aria-hidden="true"></i>
                                                Shipped
                                            </button>
                                            @break
                                        @case(3)
                                            <button type="button" class="btn btn-success float-right"><i class="fa fa-check" aria-hidden="true"></i>
                                                Complete
                                            </button>
                                            @break
                                        @case(4)
